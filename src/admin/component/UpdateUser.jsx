...
const UpdateUser = () => {
  ...
  useEffect(() => {
    const updatedUser = allUsers.find((user) => user.id === userId.replace(":", ""));
    if (updatedUser) {
      setformdata((prevData) => ({
        ...prevData,
        userTitle: updatedUser.fullname,
  ...
  const updateUser = async () => {
    if (formdata.userTitle === "" || formdata.userEmail === "" || formdata.userPassword === "" || formdata.userRole === "") {
    ...
    try {
      ...
      await updateDoc(doc(fireDB, "users", userId.replace(":", "")), user);
